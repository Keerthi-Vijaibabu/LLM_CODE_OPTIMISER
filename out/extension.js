...
function activate(context) {
    const disposable = vscode.commands.registerCommand("llmCOptimizer.optimize", () => {
        const panel = vscode.window.createWebviewPanel("llmCOptimizer", "LLM C Optimizer", vscode.ViewColumn.One, {
            enableScripts: true,
